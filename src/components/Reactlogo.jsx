...
Command: npx gltfjsx@6.2.8 reactlogo.gltf --transform
...
export default function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      <mesh geometry={nodes['React-Logo_Material002_0'].geometry} material={materials['Material.002']} position={[0, 0.079, 0.181]} rotation={[0, 0, -Math.PI / 2]} scale={0.4} />
    </group>
  )
}
